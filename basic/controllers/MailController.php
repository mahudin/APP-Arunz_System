	    ...
	    <html>
	        <head>
	            ...
	            <style>
                    ...
                    p    {font:normal 16px "Open Sans", sans-serif!important; width:400px;}
                </style>
	        </head>
	        <body>
	        <br/><br/>
	        ...
	        <p>
                Zapisałeś się na '.$maraton->title.', pobraliśmy płatność w wysokości '.$kwota.' zł. <br/>
                Skup się na przygotowaniach, a my zajmiemy się za Ciebie resztą:<br/>

                Przed startem prześlemy Ci:
                <ul style="list-style-type: disc">
                    <li>  Informacje o trasie i pogodzie </li>
                    <li>  Wszelkie niezbędne wskazówki, tak byś dobiegł na metę zadowolony </li>
                    <li>  Przypomnienie o starcie wraz z informacją jak dotrzeć na start </li>
                </ul>
                <br/>
            ...
            <br/>
            <img style="margin:0 auto;text-align:center" src="http://www.arunz.eu/preview/logo_ArunZ.svg"/>
            <br/><br/>
            <hr/>
            Jeśli potrzebujesz pomocy to napisz do nas śmiało:<br/>
             janberdychowski@arunz.eu
            <br/>
	        </p>
	        </body>
	    </html>';
